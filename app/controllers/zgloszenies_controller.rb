class ZgloszeniesController < ApplicationController
  ...
  private
    ...
    def zgloszeny_params
      params.require(:zgloszenie).permit(:klient_id, :pracownik_id, :dzial_id, :priorytet, :status, :data_zgloszenia, :data_naprawy, :opis_uszkodzenia, :nazwa_urzadzenia, :wysylka)
    end
end
